...
class Pitch():
	def __init__(self):
		...
		self.scale = Scale(self.root, orient='horizontal', from_=-100, to=100, label= 'Kp',width = "20", length = "100",troughcolor="red")
		self.scale1 =Scale(self.root, orient='horizontal', from_=-10, to=10, label= 'Ki',width = "20", length = "100",troughcolor="green")
		self.scale2 =Scale(self.root, orient='horizontal', from_=-50, to=50, label= 'Kd',width = "20", length = "100", troughcolor="blue")
...
class Yaw():
	def __init__(self):
		...
		self.scale = Scale(self.root, orient='horizontal', from_=0, to=5000, label= 'Kp',width = "20", length = "100",troughcolor="red")
		self.scale1 =Scale(self.root, orient='horizontal', from_=0, to=5000, label= 'Ki',width = "20", length = "100",troughcolor="green")
		self.scale2 =Scale(self.root, orient='horizontal', from_=0, to=5000, label= 'Kd',width = "20", length = "100", troughcolor="blue")
		# scale3 =Scale(root, orient='horizontal', from_=0, to=300, label= 'Kp_z',width = "50", length = "500", troughcolor="gray")
		self.scale.pack()
		self.scale1.pack()
		self.scale2.pack()
